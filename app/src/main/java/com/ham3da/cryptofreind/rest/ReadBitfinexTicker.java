...
public class ReadBitfinexTicker
{
    ...
    public void updateCurrencyList(boolean checkAlarms)
    {
        ...
        String url = "https://api.ham3da.ir/v1/?my_action=get_prices";
        stringRequest = new StringRequest(Request.Method.GET, url,
                response ->
                {
                    ...
                    else
                    {
                        ...
                        } catch (JSONException e)
                        {
                            ...
                            app.sendUpdateCurrencyFailNotify(mContext.getString(R.string.has_error )+"[E2]");
                ...
                error ->
                {
                    app.sendUpdateCurrencyFailNotify(mContext.getString(R.string.has_error )+"[E3]");
