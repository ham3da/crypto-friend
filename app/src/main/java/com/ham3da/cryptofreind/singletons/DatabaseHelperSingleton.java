package com.ham3da.cryptofreind.singletons;
...
public class DatabaseHelperSingleton extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "Cryptofriend.db";
    ...
    private static final String DEFAULT_FAVORITE_COINS = "BTC,ETH,LTC";
    ...
    public void saveCoinFavorites(CoinFavoritesStructures favs) {
        ...
        Log.e("saveCoinFavorites", "saveCoinFavorites: "+favoritesListString );
        // Put the serialized paylout into a ContentValues object to prepare it for storage
